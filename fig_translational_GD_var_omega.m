...
% In this figure, we want to show the different type of trajectories
% obtained when \omega=W_perp / W_par increases, and the agreement with the
...
%%
exportgraphics(gcf,'figure_translational_general_dynamics_2.png','Resolution',500)
% exportgraphics(gcf,'figure_translational_general dynamics_2.eps','ContentType','vector')
